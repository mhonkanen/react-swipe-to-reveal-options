...
export default class SwipeToRevealOptions extends Component {
  constructor(props) {
    ...
    this.leftClick = this.leftClick.bind(this); // this.swipingHandleStylesAndDelta=this.swipingHandleStylesAndDelta.bind(this);
  }
  ...
  render() {
    ...
    return React.createElement("div", {
      ...
      className: "stro-left"
    }, leftOptions.map((option, index) => React.createElement(LeftRightButton, {
      key: `left-${index}`,
    ...
    }, rightOptions.map((option, index) => React.createElement(LeftRightButton, {
      key: `right-${index}`,
      getSpanStyle: this.getSpanStyle,
      side: "right",
      index: index,

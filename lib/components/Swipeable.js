...
export default class Swipeable extends Component {
  ...
  render() {
    ...
    const customPropNames = ['onSwiped', 'onSwipingUp', 'onSwipingRight', 'onSwipingLeft', 'onSwipedUp', 'onSwipedRight', 'onSwipedDown', 'onSwipedLeft', 'flickThreshold', 'onPanStart', 'onPanMove', 'onPanLeft', 'onPanRight', 'delta'];
